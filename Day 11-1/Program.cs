...
namespace Day_11_1
{
    class Program
    {
        ...
        {
            Console.WriteLine("AdventOfCode - Day 11-1\n");
        ...
        public class Place
        {
            ...
            public bool PrepareNextStep()
            {
                ...
                else if (neighboursUsed >= 4 && state == PlaceState.USED)
            ...
            byte CalculateNeighbours()
            {
                ...
                {
                    if (x + v.x < 0 || x + v.x >= map.GetLength(0) || y + v.y < 0 || y + v.y >= map.GetLength(1))
                        continue;

                    if (map[x + v.x, y + v.y].state == PlaceState.USED)
                        counter++;
                }
